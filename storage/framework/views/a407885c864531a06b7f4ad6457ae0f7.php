...
<body class="bg-[#f4ecdc]">
    <div class="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
        <div class="mb-6 flex items-center justify-between">
            ...
            <a href="<?php echo e(route('home')); ?>" class="rounded-lg border border-[#4b729f] px-4 py-2 text-sm text-[#4b729f]">Inicio</a>
        </div>

        <div class="cmm-card p-6">
            <?php if($errors->any()): ?>
                <div class="mb-4 rounded-lg border border-red-200 bg-red-50 p-3 text-sm text-red-700"><?php echo e($errors->first()); ?></div>
            <?php endif; ?>
            <form method="POST" action="<?php echo e(route('public.pqrsf.store')); ?>" enctype="multipart/form-data" class="grid gap-4 md:grid-cols-2">
                <?php echo csrf_field(); ?>
                <div>
                    ...
                    <select name="pqrsf_tipo_id" class="mt-1 w-full rounded-lg border-[#e7e7e7]" required>
                        ...
                        <?php $__currentLoopData = $tipos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($tipo->id); ?>"><?php echo e($tipo->nombre); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div>
                    ...
                    <select name="destinatario_id" class="mt-1 w-full rounded-lg border-[#e7e7e7]" required>
                        ...
                        <?php $__currentLoopData = $destinatarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $destinatario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($destinatario->id); ?>"><?php echo e($destinatario->nombre); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
...
<?php /**PATH /home/sysocoqv/pqrs/resources/views/public/pqrsf/create.blade.php ENDPATH**/ ?>